...
export default ({ renderLeft, withinFileEditor, isNewFile }: Props) => {
    ...
    return (
        <div css={tw`flex flex-grow-0 items-center text-base text-neutral-300 overflow-x-hidden`}>
            {renderLeft || <div css={tw`w-12`} />}/<span css={tw`px-1 text-neutral-100`}>home</span>/
            <NavLink to={`/server/${id}/files`} css={tw`px-1 text-neutral-100 no-underline hover:text-neutral-50`}>
                container
            </NavLink>
            /
                ...
                crumb.path ? (
                    <React.Fragment key={index}>
                        <NavLink
                            ...
                            css={tw`px-1 text-neutral-100 no-underline hover:text-neutral-50`}
                        >
                            {crumb.name}
                        </NavLink>
                        /
